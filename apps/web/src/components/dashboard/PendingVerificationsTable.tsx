        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-100 dark:border-[#30363D]">
              ...
              <th className="text-left text-xs font-medium text-gray-500 dark:text-[#8B949E] uppercase tracking-wider px-4 py-3">Competition</th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-[#8B949E] uppercase tracking-wider px-4 py-3">Requested On</th>
              <th className="text-right text-xs font-medium text-gray-500 dark:text-[#8B949E] uppercase tracking-wider px-4 py-3">Action</th>
            </tr>
          </thead>
          <tbody>
            {data.length === 0 ? (
              <tr>
                <td colSpan={4} className="text-center py-8 text-gray-500 dark:text-[#8B949E]">{t('common.noData')}</td>
              </tr>
            ) : (
              data.map((reg) => {
