        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-100 dark:border-zinc-700">
              <th className="text-left text-xs font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wider px-4 py-3">
                Student
              </th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wider px-4 py-3">
                Competition
            ...
            {data.length === 0 ? (
              ...
              data.map((reg) => (
                <tr key={reg.id} className="border-b border-gray-50 dark:border-zinc-800 hover:bg-gray-50/50 dark:hover:bg-zinc-800/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600 dark:text-zinc-400">{reg.competition.organizer}</td>
